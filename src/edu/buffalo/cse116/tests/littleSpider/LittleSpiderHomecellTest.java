...
public class LittleSpiderHomecellTest {
	...
	/*
	 *  Tests if heart and diamond cards are being correctly added to the homecell piles. Also tests if isAddingCardIsLegal for heart and diamond card
	 */
	...
	//Unsure as to why this test keeps failing. 
